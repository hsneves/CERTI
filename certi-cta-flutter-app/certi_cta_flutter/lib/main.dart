...
class _CertiCtaHomeState extends State<CertiCtaHome> {
  ...
  final PokeballsWidget pokeballsWidget = PokeballsWidget(pokemonService);

  @override
  void initState() {
    // Evento de captura de pokemon
    eventBus.on<PokemonCaughtEvent>().listen((event) {
      ...
      pokemonService.handlePokeball(event.pokeball);
      // atualiza a tabela de pokemons capturados
      refreshPokemonCaughtTable();
    });

    // Evento de pokebollas carregadas
    ...
    eventBus.on<SseConnectionEvent>().listen((event) {
      ...
      if (event.connected) {
        ...
        // recarrega as pokebolas do servidor
        pokemonService.getPokeballsFromServer();
        // recarrega o widget de pokemons
        refreshPokemonCaughtTable();
      } else {
        logger.e("SSE Desconectado!");
        // remove todos os pokemons
        pokemonService.clearPokeballs();
        refreshPokemonCaughtTable();
        // atualiza texto de erro com a mensagem de servidor indisponível
        refreshState();
      }
    });
          ...
          children: <Widget>[
            ...
            TextButton(
              style: TextButton.styleFrom(
                ...
                backgroundColor: const Color.fromARGB(255, 165, 42, 42),
