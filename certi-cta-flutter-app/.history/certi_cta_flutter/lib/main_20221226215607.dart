...
import 'package:certi_cta_flutter/views/pokeball_list_view.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            // PokeballListView(pokemonService),
            ListView.builder(
              itemCount: pokemonService.getPokeballs().length,
              prototypeItem: ListTile(
                title: Text(pokemonService.getPokeballs()[0].pokemon!.name),
              ),
              itemBuilder: (context, index) {
                return ListTile(
                  title:
                      Text(pokemonService.getPokeballs()[index].pokemon!.name),
                );
              },
            )
          ],
